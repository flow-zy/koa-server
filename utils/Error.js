...
function errorForm(code, message, data) {
    return {
        code,
        message,
        data,
...
exports.default = {
    ...
    getBlogLikeUserListError: errorForm('30016', '获取某一文章点赞用户列表失败', ''),
    ...
    getBlogCollectUserListError: errorForm('30019', '获取某一文章收藏用户列表失败', ''),
    ...
    getBlogListBySubfieldError: errorForm('30028', '获取分栏下的文章列表失败', ''),
    ...
    removeCircleFriendCommentError: errorForm('10001', '删除朋友圈评论失败', ''),
    updateCircleFriendCommentError: errorForm('10001', '修改朋友圈评论失败', ''),
    getCommentListByCircleFriendIdError: errorForm('10001', '获取朋友圈评论列表失败', ''),
